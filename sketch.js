...
function setup() {
  ...
  Background = createSprite(400,100,500,600);
  Background.scale = 5;
...
endline = createSprite(250,700,2000,5);
...
fill("white");
textSize(40);
text("GAME OVER!",canvas.width/2-650,canvas.height/6);
text("The asteroids destroyed the planet",canvas.width/2-750,canvas.height/4);
text("Your final score:"+score,canvas.width/2-650,canvas.height/3);
}
}
function asteroids() {
  if(frameCount % 110 === 0) {
